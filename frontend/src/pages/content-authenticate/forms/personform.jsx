    ...
    const personform = () => {
        ...
        const goagencyform=()=>{
            navigator("/authenticate/agencyform");
        };
        ...
        <div className="w-full max-w-md -translate-y-20 p-4 bg-white border border-gray-400 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <h5 className="text-xl font-medium text-gray-900 dark:text-white">Format your personal data</h5>
            <div className="my-[20px] animate-fade-left animate-once animate-duration-1000">
                    ...
                    <div className="flex justify-between gap-x-1 xs:flex-col xs:gap-y-5 sm:flex-col sm:gap-y-5 md:flex-col md:gap-y-5 lg:flex-col lg:gap-y-5">
                        <div >
                        <svg className="h-8 w-8 text-primary"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="5" r="2" />  <path d="M10 22v-5l-1-1v-4a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4l-1 1v5" /></svg>
                        </div>
                        <RadioComponent  color="blue" label="Man" value="1" />
                        <div>
                        <svg className="h-8 w-8 text-primary"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="5" r="2" />  <path d="M10 22v-4h-2l2 -6a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1l2 6h-2v4" /></svg>
                        </div>
            ...
            <ButtonFullComponent type="submit"  color="blue"className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" func={goagencyform} lable="Update data"></ButtonFullComponent>
